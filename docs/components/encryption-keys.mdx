...
description: "Declare cryptographic key requirements in cldctl components"
---

# Encryption Keys

Declare cryptographic key requirements for your component. The datacenter is responsible for generating and securely managing these keys—you just specify what type of keys you need.
