...
Components are developer-focused application bundles defined in an `cloud.component.yml` file. They describe what your application needs without specifying how infrastructure should be provisioned.
