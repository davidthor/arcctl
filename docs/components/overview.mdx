...
When enabled, use `arcctl logs` to view workload logs and `arcctl observability dashboard` to open the monitoring UI. See the [full observability docs](/components/observability) for details.
