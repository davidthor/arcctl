...
1. **Declaration**: Platform engineers declare components in the datacenter file with their source and variable values, or register them via `arcctl deploy component`
