...
components:
  my-app:
    component: ghcr.io/org/my-app:v1.0.0
    routes:
...
components:
  my-app:
    component: ghcr.io/org/my-app:pr-${{ pr_number }}
    routes:
      main:
        hostnames:
...
components:
  ...
  admin-portal:
    component: ghcr.io/myorg/admin:v1.0.0
    routes:
      admin:
        hostnames:
          - subdomain: admin
...
The datacenter's ingress hook typically handles DNS record creation automatically.
