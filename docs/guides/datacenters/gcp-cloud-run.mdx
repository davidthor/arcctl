...
<Info>
This is an officially maintained datacenter template. Source: [`official-templates/gcp-cloud-run/`](https://github.com/davidthor/arcctl/tree/main/official-templates/gcp-cloud-run)
</Info>
