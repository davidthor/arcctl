...
<Info>
This is an officially maintained datacenter template. Source: [`official-templates/vercel-functions/`](https://github.com/architect-io/arcctl/tree/main/official-templates/vercel-functions)
</Info>
