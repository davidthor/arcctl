...
# Deploy new version
arcctl component deploy my-app -e staging \
  --config ghcr.io/myorg/my-app:v1.1.0
```
...
# Deploy PR build
arcctl component deploy my-app -e preview-$PR_NUMBER \
  --config ghcr.io/myorg/my-app:pr-$PR_NUMBER
...
```bash
# Show command help
arcctl component deploy --help

# Verbose output for debugging
arcctl component deploy my-app -e staging --config . --verbose
```
