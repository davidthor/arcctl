...
<CardGroup cols={2}>
  ...
  <Card title="Shared Database Datacenter" icon="database" href="/guides/datacenters/shared-database">
    Cost-effective shared databases for previews
  </Card>
